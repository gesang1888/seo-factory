"""Country-specific Lovegobuy shipping reference tables (estimates, not quotes)."""
...
# Estimated ranges — always verify live lines in Lovegobuy before paying.
SHIPPING_TABLES: dict[str, dict] = {
    ...
    "ES": {
        ...
        "note": (
            ...
            "Confirma siempre la tarifa final en Lovegobuy antes de pagar."
        ),
        "rows": [
    ...
    "FR": {
        ...
        "note": (
            ...
            "et du dédouanement. Vérifiez toujours le montant final dans Lovegobuy."
        ),
        "rows": [
    ...
    "AT": {
        ...
        "note": (
            ...
            "und der Zollabfertigung ab. Finalen Preis immer in Lovegobuy prüfen."
        ),
        "rows": [
    ...
    "UK": {
        "currency": "GBP",
        "note": "UK estimates for planning — confirm live Lovegobuy lines before checkout.",
        "rows": [
    ...
    "DE": {
        "currency": "EUR",
        "note": "Deutschland — Schätzwerte zur Planung; Live-Preis in Lovegobuy prüfen.",
        "rows": [
