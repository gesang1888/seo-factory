#!/usr/bin/env python3
"""PUT CNShopper spreadsheet, OrientDig UK, ACBuy CA, SugarGoo US homepages.

Path-mapped alias (dest unique after PUT):
  cnshopper.net → cnshopperspreadsheet.net
    unknown paths → dest /  (alias has no overlapping CMS)

Never PUT orientdig.us / sugargoospreadsheetnow.com / fashionrepsspreadsheet /
hipobuyspreadsheet.net / lovegobuyguide / wemimi.net.

  export BT_KEY='...'
  python3 scripts/evasion_cnshopper_orient_acbuy_sugargoo_apply.py --apply
"""
...
PUTS = {
    "cnshopperspreadsheet.net": ROOT / "sites/cnshopperspreadsheet.net/overlay/index.html",
    "orientdigspreadsheet.uk": ROOT / "sites/orientdigspreadsheet.uk/overlay/index.html",
    "acbuyspreadsheets.ca": ROOT / "sites/acbuyspreadsheets.ca/overlay/index.html",
    "sugargoospreadsheets.us": ROOT / "sites/sugargoospreadsheets.us/overlay/index.html",
}

ALIASES = {
    "cnshopper.net": ("https://cnshopperspreadsheet.net", [], {}),
}
