"""Trust / legal pages for each OrientDig domain."""
...
TRUST_PAGES: dict[str, dict[str, dict]] = {
    "about": {
        "en": {
            "title": "About OrientDig Spreadsheet Guide",
            "description": "About this independent OrientDig spreadsheet resource hub with W2CLinks browsing and WhatsApp help.",
            "h1": "About OrientDig Spreadsheet Guide",
            "intro": "This site is an independent resource for OrientDig spreadsheet searchers. We explain how to browse finds on W2CLinks and register on OrientDig with referral support.",
            "sections": [
                (
                    "What we do",
                    "We publish country-specific guides for shipping, QC, coupons and spreadsheet browsing. "
                    "Product actions open W2CLinks in a new tab; orders are placed on OrientDig.",
                ),
                (
                    "What we are not",
                    "This is not the official OrientDig website and not a local product store. "
                    "We do not host checkout or warehouse tools.",
                ),
            ],
        },
        "nl": {
            "title": "Over OrientDig Spreadsheet Guide",
            "description": "Over deze onafhankelijke OrientDig spreadsheet resource met W2CLinks en WhatsApp.",
            "h1": "Over OrientDig Spreadsheet Guide",
            "intro": "Onafhankelijke gids voor OrientDig spreadsheet-zoekers in Nederland en Europa.",
            "sections": [
                ("Wat we doen", "Guides voor verzending, QC, coupons en W2CLinks spreadsheet browsing."),
                ("Wat we niet zijn", "Geen officiële OrientDig-site en geen lokale winkel."),
            ],
        },
        "de": {
            "title": "Über OrientDig Spreadsheet Guide",
            "description": "Unabhängige OrientDig Spreadsheet-Ressource mit W2CLinks und WhatsApp.",
            "h1": "Über OrientDig Spreadsheet Guide",
            "intro": "Unabhängiger Guide für OrientDig Spreadsheet-Nutzer.",
            "sections": [
                ("Was wir tun", "Guides zu Versand, QC, Gutscheinen und W2CLinks Spreadsheet."),
                ("Was wir nicht sind", "Keine offizielle OrientDig-Website."),
            ],
        },
        "it": {
            "title": "Informazioni su OrientDig Spreadsheet Guide",
            "description": "Risorsa indipendente OrientDig spreadsheet con W2CLinks e WhatsApp.",
            "h1": "Informazioni su OrientDig Spreadsheet Guide",
            "intro": "Guida indipendente per chi cerca orientdig spreadsheet.",
            "sections": [
                ("Cosa facciamo", "Guide su spedizione, QC, coupon e spreadsheet W2CLinks."),
                ("Cosa non siamo", "Non siamo il sito ufficiale OrientDig."),
            ],
        },
        "fr": {
            "title": "À propos du guide OrientDig Spreadsheet",
            "description": "Ressource indépendante OrientDig spreadsheet avec W2CLinks et WhatsApp.",
            "h1": "À propos du guide OrientDig Spreadsheet",
            "intro": "Guide indépendant pour les recherches orientdig spreadsheet en France.",
            "sections": [
                ("Notre rôle", "Guides livraison, QC, coupons et tableur W2CLinks."),
                ("Ce que nous ne sommes pas", "Pas le site officiel OrientDig."),
            ],
        },
    },
    "contact": {
        "en": {
            "title": "Contact — OrientDig Spreadsheet Guide",
            "description": "Contact this independent OrientDig spreadsheet resource via WhatsApp.",
            "h1": "Contact",
            "intro": "Use WhatsApp for spreadsheet browsing help. Order issues go to OrientDig support.",
            "sections": [
                ("WhatsApp", "Message us on WhatsApp for guide questions about W2CLinks and OrientDig workflow."),
                ("OrientDig orders", "For parcel, payment or QC issues contact OrientDig Help Center or service@orientdig.com."),
            ],
        },
    ...
    "privacy-policy": {
        "en": {
            ...
            "description": "Privacy policy for OrientDig Spreadsheet Guide static resource sites.",
            "h1": "Privacy Policy",
            ...
            "sections": [
                ...
                ("Third parties", "Outbound links to W2CLinks and OrientDig have their own policies."),
            ],
        },
    ...
    "terms": {
        "en": {
            "title": "Terms of Use",
            "description": "Terms for using OrientDig Spreadsheet Guide resource pages.",
            "h1": "Terms of Use",
            "intro": "By using this site you agree these pages are informational only.",
            "sections": [
                ("No guarantees", "Shipping times, coupons and product availability can change on OrientDig."),
                ("Affiliate links", "Some OrientDig register links may include referral parameters."),
            ],
        },
    ...
    "affiliate-disclosure": {
        "en": {
            ...
            "description": "Affiliate and referral disclosure for OrientDig Spreadsheet Guide.",
            "h1": "Affiliate Disclosure",
            "intro": "We may earn referral benefits when you register on OrientDig through our links.",
            "sections": [
                ("W2CLinks", "Spreadsheet browsing opens W2CLinks — our primary product-find hub."),
                ("OrientDig register", "Register links may include ref= invitation codes."),
            ],
        },
    ...
    "partner-disclosure": {
        "en": {
            ...
            "description": "Relationship disclosure for OrientDig Spreadsheet Guide.",
            "h1": "Partner Disclosure",
            "intro": "This is an independent guide site, not an official OrientDig property.",
            "sections": [
                ("Independence", "We are not authorized to speak for OrientDig customer service."),
                ("Trademarks", "OrientDig trademarks belong to their respective owners."),
            ],
        },
...
def get_trust_page(slug: str, lang: str) -> dict | None:
    ...
    return {
        "slug": slug,
        "cta": "Open OrientDig Spreadsheet",
