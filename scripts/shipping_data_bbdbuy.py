"""Country-specific BBDBuy shipping reference tables (estimates, not quotes)."""
...
# Estimated ranges — always verify live lines in BBDBuy before paying.
SHIPPING_TABLES: dict[str, dict] = {
    ...
    "ES": {
        ...
        "note": (
            ...
            "Confirma siempre la tarifa final en BBDBuy antes de pagar."
        ),
        "rows": [
    ...
    "FR": {
        ...
        "note": (
            ...
            "et du dédouanement. Vérifiez toujours le montant final dans BBDBuy."
        ),
        "rows": [
    ...
    "AT": {
        ...
        "note": (
            ...
            "und der Zollabfertigung ab. Finalen Preis immer in BBDBuy prüfen."
        ),
        "rows": [
    ...
    "UK": {
        "currency": "GBP",
        "note": "UK estimates for planning — confirm live BBDBuy lines before checkout.",
        "rows": [
    ...
    "DE": {
        "currency": "EUR",
        "note": "Deutschland — Schätzwerte zur Planung; Live-Preis in BBDBuy prüfen.",
        "rows": [
