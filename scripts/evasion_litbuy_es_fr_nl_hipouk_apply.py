#!/usr/bin/env python3
"""PUT LitBuy ES/FR/NL + HipoBuy .uk haul-log homepages.

Path-mapped alias (dest unique):
  fansbuyspreadsheet.eu → fansbuy.eu
    overlapping CMS slugs only; unknown paths → dest /

Never PUT hipobuyspreadsheet.net / lovegobuyguide / fashionrepsspreadsheet /
wemimi.net / kakobuydocs inner CMS. Never 301 hipobuyspreadsheets.uk onto .co.uk.

  export BT_KEY='...'
  python3 scripts/evasion_litbuy_es_fr_nl_hipouk_apply.py --apply
"""
...
PUTS = {
    "litbuyspreadsheets.es": ROOT / "sites/litbuyspreadsheets.es/overlay/index.html",
    "litspreadsheet.fr": ROOT / "sites/litspreadsheet.fr/overlay/index.html",
    "litbuyspreadsheets.nl": ROOT / "sites/litbuyspreadsheets.nl/overlay/index.html",
    "hipobuyspreadsheets.uk": ROOT / "sites/hipobuyspreadsheets.uk/overlay/index.html",
}
...
ALIASES = {
    "fansbuyspreadsheet.eu": ("https://fansbuy.eu", FANS_EU_PATHS, {}),
}
