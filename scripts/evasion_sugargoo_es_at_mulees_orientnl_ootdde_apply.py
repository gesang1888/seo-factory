#!/usr/bin/env python3
"""PUT SugarGoo ES/AT, MuleBuy ES, OrientDig NL, OOTDBuy DE homepages.

Path-mapped alias (dest unique after this PUT; alias is a 5 KB skin, inner 404):
  orientdigspreadsheets.nl → https://orientdigspreadsheet.nl
    dest-200 slugs map 1:1 (both /orientdig-spreadsheet/ and /spreadsheets/ are 200)
    unknown paths → dest /

Never PUT sugargoo.es (98 KB CMS), sugargoo.nl, ootdbuyspreadsheet.net/.org,
hipobuyspreadsheet.net, mulebuy.fr, orientdig.us, bbdbuyeu.net.

  export BT_KEY='...'
  python3 scripts/evasion_sugargoo_es_at_mulees_orientnl_ootdde_apply.py --apply
"""
...
PUTS = {
    "sugargoospreadsheet.es": ROOT / "sites/sugargoospreadsheet.es/overlay/index.html",
    "sugargoo.at": ROOT / "sites/sugargoo.at/overlay/index.html",
    "mulebuyspreadsheets.es": ROOT / "sites/mulebuyspreadsheets.es/overlay/index.html",
    "orientdigspreadsheet.nl": ROOT / "sites/orientdigspreadsheet.nl/overlay/index.html",
    "ootdbuyspreadsheet.de": ROOT / "sites/ootdbuyspreadsheet.de/overlay/index.html",
}
...
ALIASES = {
    "orientdigspreadsheets.nl": (
        "https://orientdigspreadsheet.nl",
        OD_NL_PATHS,
        {},
    ),
}
