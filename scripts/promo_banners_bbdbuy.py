"""BBDBuy-style home activity promo banners (coupon / guide / shipping)."""
...
PROMO_ITEMS = [
    ...
    },
    {
        ...
        "slugs": {lang: "/how-to-use-bbdbuy/" for lang in ("en", "nl", "de", "it", "fr")},
    ...
    },
    {
        ...
        "region_slugs": {
            "US": "/bbdbuy-shipping-calculator/",
            "UK": "/how-long-does-bbdbuy-take-to-ship/",
        },
