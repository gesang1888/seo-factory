...
FILES = [
    ...
    ROOT / "sites/orientdigspreadsheet.it/overlay/index.html",
    ...
    ROOT / "sites/ootdbuyspreadsheet.co.uk/overlay/index.html",
    ...
    ROOT / "sites/bbdbuyspreadsheet.de/overlay/index.html",
