#!/usr/bin/env python3
"""PUT Superbuy IT/US, OrientDig US spreadsheet, SugarGoo DE homepages.

Path-mapped aliases (dest unique after prior hands):
  orientdigspreadsheets.de → orientdigspreadsheet.de
  orientdigspreadsheets.uk → orientdigspreadsheet.uk
    /orientdig-spreadsheet/ → /orientdig-spreadsheets/
    unknown paths → dest /

Never PUT orientdig.us / sugargoospreadsheetnow.com / hipobuyspreadsheet.net
/ fashionrepsspreadsheet.com / lovegobuyguide.com / wemimi.net.

  export BT_KEY='...'
  python3 scripts/evasion_superbuy_orientus_sugargoo_de_apply.py --apply
"""
...
PUTS = {
    "superbuyspreadsheets.it": ROOT / "sites/superbuyspreadsheets.it/overlay/index.html",
    "superbuyspreadsheets.us": ROOT / "sites/superbuyspreadsheets.us/overlay/index.html",
    "orientdigspreadsheet.us": ROOT / "sites/orientdigspreadsheet.us/overlay/index.html",
    "sugargoospreadsheets.de": ROOT / "sites/sugargoospreadsheets.de/overlay/index.html",
}
...
ALIASES = {
    "orientdigspreadsheets.de": (
        "https://orientdigspreadsheet.de",
        OD_PATHS,
        OD_REMAPS,
    ),
    "orientdigspreadsheets.uk": (
        "https://orientdigspreadsheet.uk",
        OD_PATHS,
        OD_REMAPS,
    ),
}
