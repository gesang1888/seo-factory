"""Trust / legal pages for each Kakobuy domain."""
...
TRUST_PAGES: dict[str, dict[str, dict]] = {
    "about": {
        "en": {
            "title": "About Kakobuy Spreadsheet Guide",
            "description": "About this independent Kakobuy spreadsheet resource hub with W2CLinks browsing and WhatsApp help.",
            "h1": "About Kakobuy Spreadsheet Guide",
            "intro": "This site is an independent resource for Kakobuy spreadsheet searchers. We explain how to browse finds on W2CLinks and register on Kakobuy with referral support.",
            "sections": [
                (
                    "What we do",
                    "We publish country-specific guides for shipping, QC, coupons and spreadsheet browsing. "
                    "Product actions open W2CLinks in a new tab; orders are placed on Kakobuy.",
                ),
                (
                    "What we are not",
                    "This is not the official Kakobuy website and not a local product store. "
                    "We do not host checkout or warehouse tools.",
                ),
            ],
        },
        "nl": {
            "title": "Over Kakobuy Spreadsheet Guide",
            "description": "Over deze onafhankelijke Kakobuy spreadsheet resource met W2CLinks en WhatsApp.",
            "h1": "Over Kakobuy Spreadsheet Guide",
            "intro": "Onafhankelijke gids voor Kakobuy spreadsheet-zoekers in Nederland en Europa.",
            "sections": [
                ("Wat we doen", "Guides voor verzending, QC, coupons en W2CLinks spreadsheet browsing."),
                ("Wat we niet zijn", "Geen officiële Kakobuy-site en geen lokale winkel."),
            ],
        },
        "de": {
            "title": "Über Kakobuy Spreadsheet Guide",
            "description": "Unabhängige Kakobuy Spreadsheet-Ressource mit W2CLinks und WhatsApp.",
            "h1": "Über Kakobuy Spreadsheet Guide",
            "intro": "Unabhängiger Guide für Kakobuy Spreadsheet-Nutzer.",
            "sections": [
                ("Was wir tun", "Guides zu Versand, QC, Gutscheinen und W2CLinks Spreadsheet."),
                ("Was wir nicht sind", "Keine offizielle Kakobuy-Website."),
            ],
        },
        "it": {
            "title": "Informazioni su Kakobuy Spreadsheet Guide",
            "description": "Risorsa indipendente Kakobuy spreadsheet con W2CLinks e WhatsApp.",
            "h1": "Informazioni su Kakobuy Spreadsheet Guide",
            "intro": "Guida indipendente per chi cerca kakobuy spreadsheet.",
            "sections": [
                ("Cosa facciamo", "Guide su spedizione, QC, coupon e spreadsheet W2CLinks."),
                ("Cosa non siamo", "Non siamo il sito ufficiale Kakobuy."),
            ],
        },
        "fr": {
            "title": "À propos du guide Kakobuy Spreadsheet",
            "description": "Ressource indépendante Kakobuy spreadsheet avec W2CLinks et WhatsApp.",
            "h1": "À propos du guide Kakobuy Spreadsheet",
            "intro": "Guide indépendant pour les recherches kakobuy spreadsheet en France.",
            "sections": [
                ("Notre rôle", "Guides livraison, QC, coupons et tableur W2CLinks."),
                ("Ce que nous ne sommes pas", "Pas le site officiel Kakobuy."),
            ],
        },
    },
    "contact": {
        "en": {
            "title": "Contact — Kakobuy Spreadsheet Guide",
            "description": "Contact this independent Kakobuy spreadsheet resource via WhatsApp.",
            "h1": "Contact",
            "intro": "Use WhatsApp for spreadsheet browsing help. Order issues go to Kakobuy support.",
            "sections": [
                ("WhatsApp", "Message us on WhatsApp for guide questions about W2CLinks and Kakobuy workflow."),
                ("Kakobuy orders", "For parcel, payment or QC issues contact Kakobuy Help Center via kakobuy.com."),
            ],
        },
    ...
    "privacy-policy": {
        "en": {
            ...
            "description": "Privacy policy for Kakobuy Spreadsheet Guide static resource sites.",
            "h1": "Privacy Policy",
            ...
            "sections": [
                ...
                ("Third parties", "Outbound links to W2CLinks and Kakobuy have their own policies."),
            ],
        },
    ...
    "terms": {
        "en": {
            "title": "Terms of Use",
            "description": "Terms for using Kakobuy Spreadsheet Guide resource pages.",
            "h1": "Terms of Use",
            "intro": "By using this site you agree these pages are informational only.",
            "sections": [
                ("No guarantees", "Shipping times, coupons and product availability can change on Kakobuy."),
                ("Affiliate links", "Some Kakobuy register links may include referral parameters."),
            ],
        },
    ...
    "affiliate-disclosure": {
        "en": {
            ...
            "description": "Affiliate and referral disclosure for Kakobuy Spreadsheet Guide.",
            "h1": "Affiliate Disclosure",
            "intro": "We may earn referral benefits when you register on Kakobuy through our links.",
            "sections": [
                ("W2CLinks", "Spreadsheet browsing opens W2CLinks — our primary product-find hub."),
                ("Kakobuy register", "Register links may include ref= invitation codes."),
            ],
        },
    ...
    "partner-disclosure": {
        "en": {
            ...
            "description": "Relationship disclosure for Kakobuy Spreadsheet Guide.",
            "h1": "Partner Disclosure",
            "intro": "This is an independent guide site, not an official Kakobuy property.",
            "sections": [
                ("Independence", "We are not authorized to speak for Kakobuy customer service."),
                ("Trademarks", "Kakobuy trademarks belong to their respective owners."),
            ],
        },
