#!/usr/bin/env python3
"""PUT kakobuydocs + HipoBuy UK + LitBuy EU + FansBuy DE homepages.

Path-mapped same-country aliases (dest already unique, or unique after PUT):
  kakobuytips.com → kakobuydocs.com
  ...
  fansspreadsheet.net → fansbuysheets.net
    overlapping CMS slugs only; unknown paths → dest /

Never PUT hipobuyspreadsheet.net / kakobuydocs inner CMS / lovegobuyguide.
Never 301 lovegobuyspreadsheet.nl or hipobuyspreadsheets.uk.

  export BT_KEY='...'
  python3 scripts/evasion_docs_uk_eu_de_apply.py --apply
"""
...
PUTS = {
    "kakobuydocs.com": ROOT / "sites/kakobuydocs.com/overlay/index.html",
    "hipobuyspreadsheet.co.uk": ROOT / "sites/hipobuyspreadsheet.co.uk/overlay/index.html",
    "litbuyspreadsheet.eu": ROOT / "sites/litbuyspreadsheet.eu/overlay/index.html",
    "fansbuyspreadsheet.de": ROOT / "sites/fansbuyspreadsheet.de/overlay/index.html",
}

DOCS_PATHS = [
    "kakobuy-coupons",
    "kakobuy-invite-code",
    "kakobuy-shoes-spreadsheet",
    "kakobuy-spreadsheet",
    "how-to-use-kakobuy",
    "is-kakobuy-legit",
    "kakobuy-qc-guide",
...
ALIASES = {
    "kakobuytips.com": ("https://kakobuydocs.com", DOCS_PATHS, DOCS_REMAPS),
    "orientdigspreadsheet.fr": ("https://orientdig.fr", ORIENT_PATHS, ORIENT_REMAPS),
    "fansspreadsheet.net": ("https://fansbuysheets.net", FANS_NET_PATHS, {}),
}
