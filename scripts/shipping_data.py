"""Country-specific OrientDig shipping reference tables (estimates, not quotes)."""
...
# Estimated ranges — always verify live lines in OrientDig before paying.
SHIPPING_TABLES: dict[str, dict] = {
    ...
    "ES": {
        ...
        "note": (
            ...
            "Confirma siempre la tarifa final en OrientDig antes de pagar."
        ),
        "rows": [
    ...
    "FR": {
        ...
        "note": (
            ...
            "et du dédouanement. Vérifiez toujours le montant final dans OrientDig."
        ),
        "rows": [
    ...
    "AT": {
        ...
        "note": (
            ...
            "und der Zollabfertigung ab. Finalen Preis immer in OrientDig prüfen."
        ),
        "rows": [
    ...
    "UK": {
        "currency": "GBP",
        "note": "UK estimates for planning — confirm live OrientDig lines before checkout.",
        "rows": [
    ...
    "DE": {
        "currency": "EUR",
        "note": "Deutschland — Schätzwerte zur Planung; Live-Preis in OrientDig prüfen.",
        "rows": [
